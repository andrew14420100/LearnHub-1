                ...
                <div>
                  ...
                  <Select value={course.language || 'it'} onValueChange={(val) => setCourse(prev => ({ ...prev, language: val }))}>
                    ...
                    <SelectContent className="max-h-64">
                      ...
                      <SelectItem value="nl">Olandese</SelectItem>
                      <SelectItem value="pl">Polacco</SelectItem>
                      <SelectItem value="ro">Rumeno</SelectItem>
                      <SelectItem value="sv">Svedese</SelectItem>
                      <SelectItem value="da">Danese</SelectItem>
                      <SelectItem value="fi">Finlandese</SelectItem>
                      <SelectItem value="no">Norvegese</SelectItem>
                      <SelectItem value="el">Greco</SelectItem>
                      <SelectItem value="cs">Ceco</SelectItem>
                      <SelectItem value="hu">Ungherese</SelectItem>
                      <SelectItem value="tr">Turco</SelectItem>
                      <SelectItem value="ru">Russo</SelectItem>
                      <SelectItem value="uk">Ucraino</SelectItem>
                      ...
                      <SelectItem value="th">Tailandese</SelectItem>
                      <SelectItem value="vi">Vietnamita</SelectItem>
                      <SelectItem value="id">Indonesiano</SelectItem>
                      <SelectItem value="ms">Malese</SelectItem>
                      <SelectItem value="tl">Filippino</SelectItem>
                      <SelectItem value="sw">Swahili</SelectItem>
                      <SelectItem value="he">Ebraico</SelectItem>
                      <SelectItem value="fa">Persiano</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
